        ...
        <div className="w-full max-w-lg">
          ...
          <div className="text-center mb-8">
            ...
            <div className="inline-flex items-center space-x-2 sm:space-x-3 bg-white/90 backdrop-blur-sm rounded-full px-6 py-3 sm:px-8 sm:py-4 mb-6 shadow-soft border border-indigo-100/30">
              ...
              <span className="text-xs sm:text-sm font-semibold text-indigo-700">Join Parafyze</span>
            </div>
          ...
          {/* Signup Form */}
          <div className="bg-white/95  backdrop-blur-sm rounded-2xl sm:rounded-3xl shadow-beautiful border border-indigo-100/40 p-6 sm:p-8 ">
            <form className="space-y-6" onSubmit={handlesignup}>
              {/* Name Fields */}
              <div className="flex flex-col w-full ">
                <div>
                  <label htmlFor="FullName" className="block text-sm font-semibold text-gray-700 mb-3 text-shadow-soft">
                    FullName
                  </label>
              ...
              <div>
                ...
                <label className="text-rose-600 gap-2 mt-2 ml-4 flex items-center space-x-2 text-sm">{EmailError}</label>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                 ...
                 <>
                    ...
                    <p className="text-xs text-gray-500 mt-2">Password Strength: <span className={`${PasswordStrength >= 3 ? "text-green-500" : "text-red-500"} font-bold`}>{PasswordStrengthText}</span></p>
                  </div>  
                <p className="text-xs text-gray-500 mt-2">{PasswordStrengthFeedback}</p>
                </>
              </div>

              {/* Confirm Password Field */}
              <div>
                <label htmlFor="confirmPassword" className="block text-sm font-semibold text-gray-700 mb-3 text-shadow-soft">
                  Confirm Password
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                 ...
                 <>
                    <p className="text-xs text-gray-500 mt-2">Password Match: <span className={`${PasswordAndConfirmPasswordMatch ? "text-green-500" : "text-red-500"} font-bold`}>{PasswordAndConfirmPasswordMatch ? "Passwords Match" : "Passwords Do Not Match"}</span></p>
                 </>
              </div>
              ...
              <div className="space-y-4">
                <label className="flex items-start space-x-3 cursor-pointer">
                  <input
                    ...
                    className="w-4 h-4 text-indigo-600 border-indigo-300 rounded focus:ring-indigo-500 focus:ring-2 mt-1"
                  />
                  <span className="text-sm text-gray-600">
                    ...
                    and{' '}
                    <Link href="/privacy" className="text-indigo-600 hover:text-indigo-700 font-medium transition-colors duration-300">
                      Privacy Policy
                    </Link>
                  </span>
                </label>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-gradient-primary text-white font-bold py-4 px-6 rounded-xl hover:from-indigo-600 hover:via-purple-600 hover:to-purple-700 transition-all duration-300 flex items-center justify-center space-x-3 shadow-beautiful hover:shadow-glow transform hover:scale-105 text-base disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isLoading ? (
                  <>
          ...
          <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="text-center p-4 bg-white/80 backdrop-blur-sm rounded-xl shadow-soft border border-indigo-100/30">
            ...
            <div className="text-center p-4 bg-white/80 backdrop-blur-sm rounded-xl shadow-soft border border-indigo-100/30">
              ...
              <h3 className="text-sm font-semibold text-gray-900">Free to Start</h3>
            ...
            <div className="text-center p-4 bg-white/80 backdrop-blur-sm rounded-xl shadow-soft border border-indigo-100/30">
              ...
              <p className="text-xs text-gray-600">Start paraphrasing immediately</p>
            </div>
          </div>
                </div>
      </div>
